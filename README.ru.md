...
[docs-lx/lx-config.ru.md](docs-lx/lx-config.ru.md) и [фича AWG2](SPECS/FEATURES/AWG2/FEATURE.md) · [примеры](SPECS/TASKS/009-WIRESOCK_MASQUERADE_PROFILES/EXAMPLES.md).
...
[docs-lx/lx-config.ru.md §4](docs-lx/lx-config.ru.md) и [фича MASQUE_WARP](SPECS/FEATURES/MASQUE_WARP/FEATURE.md) · [полная таблица](SPECS/TASKS/021-MASQUE_CONNECT_IP_OUTBOUND/CONFIG.md).
