...
Лаунчер — **[singbox-launcher](https://github.com/Leadaxe/singbox-launcher)**, скачать со страницы релизов. В нём открыть вкладку **Remote**, нажать **Добавить** и вбить invite из сводки. Адрес в нём уже подставлен рабочий (LAN-адрес роутера), отпечаток и код — как есть; по отпечатку лаунчер пинит TLS-сертификат демона.
