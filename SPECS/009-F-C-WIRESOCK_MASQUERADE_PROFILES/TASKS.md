...
- [x] `transport/wireguard/quic_initial_awg.go`: varint, frame-план (I1–I4), сборка Initial
...
- [x] dns/stun/sip механизм проверен вживую (туннель + трафик)
- [x] QUIC фрагментированный Initial — device-smoke на активном DPI пройден (туннель + трафик)
