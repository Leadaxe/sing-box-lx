...
|------|----------|-----------|--------|
| [002-XHTTP](002-XHTTP/FEATURE.md) | XHTTP-транспорт против Xray: `packet-up` / `stream-one` / `auto`, obfs, переиспользование соединений `xmux` | `with_xhttp` | 002 · 011 · 042 · 043 · 059 · 061 · 076 · 077 · 082 |
