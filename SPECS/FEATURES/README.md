...
| [OBSERVABILITY](OBSERVABILITY/FEATURE.md) | Расширения libbox gRPC для UI: RPC, `detourList`, DNS-стрим | `with_lx_command` | 014 · 015 · 016 · 017 · 018 |
...
| [DNS_GROUP](DNS_GROUP/FEATURE.md) | Группа DNS-серверов: `failover` / `race`, `down_time`, фактический сервер в DNS-потоке | — | 033 · 034 · 035 |
