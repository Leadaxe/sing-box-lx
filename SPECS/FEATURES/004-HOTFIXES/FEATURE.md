...
- **Field-подтверждение — часть работы.** Стенд воспроизводит механизм, а
  ...
  эксплуатации: 028/029/030/041 давно в релизах, а весь хвост задач `I`/`O`
  закрыт так 2026-09-24 (более недели в поле без жалоб).
