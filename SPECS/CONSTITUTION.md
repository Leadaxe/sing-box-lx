...
`sing-box-lx` — **тонкий downstream** [SagerNet/sing-box](https://github.com/SagerNet/sing-box). Это **upstream + небольшой набор клиентских фич**, которых в upstream нет и не будет. Сейчас их две:
