...
по образцу `empty direct detour`: **не** ошибка старта, а ленивая ошибка в
`DetourDialer.init()`. Поведение (**вариант B**, согласовано с автором и
[LxBox §128](https://github.com/Leadaxe/LxBox/blob/develop/docs/spec/tasks/128-force-direct-out-detour.md)):
ядро стартует, остальные узлы работают, эта нода фейлит каждый dial с понятной
ошибкой в логе. **Не крашимся.**
