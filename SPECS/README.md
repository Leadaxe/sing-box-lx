...
| **095** | UPSTREAM_SYNC_1_14_1_PLUS_34 | **I** | Синк с `upstream/stable` (v1.14.1 + 34) по раннбуку: сначала форк-сабмодули (`wireguard-go` re-graft на v0.0.7, `sing-tun` merge осиротевшего пина 3e03774a), потом мерж ядра с шестью конфликтами в наших швах. Апстрим закрыл SPEC 082 в `v2rayhttp`/`v2raygrpclite` (`baderror.WrapH2`) и гонку из 047; SPEC 084 и 040 остаются. Живой прогон по раннбуку §1.4 впереди. [SPEC.md](TASKS/095-UPSTREAM_SYNC_1_14_1_PLUS_34/SPEC.md) |
