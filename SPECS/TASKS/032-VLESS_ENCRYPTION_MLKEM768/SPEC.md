...
- **Лицензия.** Xray-core MPL-2.0, sing-box GPL-3.0. MPL §3.3 совместимость даёт, но
  ...
  сделано для WireSock (MIT) в [[SPECS/TASKS/009-WIRESOCK_MASQUERADE_PROFILES]]. Проверить
  до мержа.
- **Приоритет.** Насколько распространены такие серверы у аудитории форка — от этого
  зависит, брать ли сейчас (ср. [[SPECS/TASKS/024-RUNTIME_LOOP_GUARD]], отложенную до
