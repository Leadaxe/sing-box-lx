...
| Status | D (done, device-verified) — core + RPC + libbox + unit tests green; closed by owner decision 2026-09-24: releases have run in the field for over a week with no reports |
| Branch | `lx` |
