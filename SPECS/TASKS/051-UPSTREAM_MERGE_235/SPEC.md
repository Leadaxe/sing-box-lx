...
| Статус | D (done, device-verified) — мерж выполнен (`f56680e0d`); дрейф сабмодулей закрыт перепрививкой на полную апстрим-ленту (`a4da5d10f`, rc.6) после того, как выборочный cherry-pick сломал rc.5; device-прогон (R4) — закрыта решением владельца 2026-09-24: релизы более недели в поле без жалоб |
| Ветка | `lx` |
