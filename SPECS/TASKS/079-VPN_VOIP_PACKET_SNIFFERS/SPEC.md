...
| Статус | D (done, device-verified) — решение владельца 2026-09-05 («OpenVPN, IKEv2/IPsec, Tailscale, SIP — делаем; остальное нет»); код, юниты, `lx-build`, `check`, прогон всех четырёх через бинарь; полевой прогон на роутере — закрыта решением владельца 2026-09-24: релизы более недели в поле без жалоб |
| Ветка | `lx` |
