...
| Статус | D (done, device-verified) — код + юниты red/green 2026-09-02; полевой прогон на стенде лаунчера — закрыта решением владельца 2026-09-24: релизы более недели в поле без жалоб |
| Ветка | `lx` |
