...
- [x] race: attempts из коллектора, SetRacer, лог гонки/смены победителя
- [x] client_log: снимок трассы в QueryEvent (+3 поля структуры)
...
- [x] Юниты по SPEC §6 (вкл. вложенную группу и write-once)
- [x] Живой box.New: медленный участник не попадает в снимок трассы
- [x] DoD: build ± теги, обе сборки §3.6, vet, gofmt
- [x] FEATURE.md DNS_GROUP + OBSERVABILITY: доработка, кросс-ссылки; Roadmap; IMPLEMENTATION_REPORT.md
