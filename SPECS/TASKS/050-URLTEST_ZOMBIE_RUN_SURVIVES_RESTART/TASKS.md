...
- [x] 21. Device-верификация на полевой подписке — закрыта решением владельца 2026-09-24 (релизы более недели в поле без жалоб) (эмулятор для этого не нужен — механизм воспроизведён в ядре; остаётся подтверждение на конфиге инцидента)
