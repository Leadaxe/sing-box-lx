...
[lx-energy.ru.md](lx-energy.ru.md). **`lazy_build`, `build_max` и `build_overflow` сейчас только
разбираются и валидируются, действовать начнут с SPEC 097**; до неё они ничего не меняют.
