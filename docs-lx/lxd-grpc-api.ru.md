...
собственный лог) живут отдельной плоскостью на admin-порту — см.
[lxd-daemon.ru.md](lxd-daemon.ru.md) и
[SPEC 065](../SPECS/TASKS/065-LXD_OBSERVABILITY_PLANE/SPEC.md).
